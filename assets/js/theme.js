...
(function ($) {
  ...
  if ($('body').hasClass('tt-transition')) {
    ...
    function HideLoad() {
      ...
      tl_transitOut.to(
        '.ptr-overlay',
        { duration: 1.5, scaleY: 0, transformOrigin: 'center top', ease: Expo.easeInOut },
        0.3
      );
      ...
      tl_transitOut.from(
        '#tt-header',
        { duration: 1.5, y: 20, autoAlpha: 0, ease: Expo.easeInOut, clearProps: 'all' },
        0.6
      );
      ...
      if ($('.ph-image').length) {
        if ($('#page-header').hasClass('ph-bg-image')) {
          tl_transitOut.from(
            ...
            { duration: 2, y: 80, autoAlpha: 0, stagger: 0.3, ease: Expo.easeOut },
            0.8
          );
        } else {
          tl_transitOut.from(
            '.ph-image',
            { duration: 2, y: 80, autoAlpha: 0, stagger: 0.3, ease: Expo.easeOut, clearProps: 'all' },
            1.2
          );
        }
      }
      ...
      if ($('.ph-appear').length) {
        tl_transitOut.from('.ph-appear', { duration: 2, y: 80, autoAlpha: 0, stagger: 0.3, ease: Expo.easeOut }, 1.5);
      }
      ...
      if ($('#page-header .project-info-list').length) {
        if ($('#page-header').hasClass('ph-inline')) {
          tl_transitOut.from(
            ...
            { duration: 2, y: 80, autoAlpha: 0, stagger: 0.15, ease: Expo.easeOut },
            2.2
          );
        } else {
          tl_transitOut.from(
            '#page-header .project-info-list > ul',
            { duration: 2, y: 80, autoAlpha: 0, ease: Expo.easeOut },
            2.2
          );
        }
      }
      ...
      if ($('.tt-pci-title').length) {
        tl_transitOut.from(
          '.tt-pci-title',
          { duration: 2, x: 80, autoAlpha: 0, skewX: '-10deg', ease: Expo.easeOut, clearProps: 'all' },
          1.4
        );
      }
      if ($('.tt-pci-category').length) {
        tl_transitOut.from(
          '.tt-pci-category',
          { duration: 2, x: 80, autoAlpha: 0, ease: Expo.easeOut, clearProps: 'all' },
          1.5
        );
      }
      if ($('.tt-pci-story-left').length) {
        tl_transitOut.from('.tt-pci-story-left', { duration: 2, xPercent: 100, ease: Power2.out }, 1.5);
      }
      if ($('.tt-pci-story-right').length) {
        tl_transitOut.from('.tt-pci-story-right', { duration: 2, xPercent: -100, ease: Power2.out }, 1.5);
      }
      if ($('.tt-pci-story-up').length) {
        tl_transitOut.from('.tt-pci-story-up', { duration: 3, yPercent: 300, ease: Power3.out }, 2);
      }
      ...
      tl_transitOut.from(
        '#page-content',
        { duration: 2, autoAlpha: 0, y: 80, ease: Expo.easeOut, clearProps: 'all' },
        0.8
      );
  ...
  $olMenuToggleBtn.on('click', function () {
    ...
    if ($('body').hasClass('tt-ol-menu-open')) {
      ...
      if ($('.tt-ol-menu-anim').length) {
        tl_olMenuIn.from(
          $('.tt-ol-menu-anim'),
          { duration: 0.4, y: 60, autoAlpha: 0, stagger: 0.05, ease: Power2.easeOut, clearProps: 'all' },
          '-=0.4'
        );
      }
      ...
      $('.tt-overlay-menu a, .tt-logo a')
        ...
        .on('click', function () {
          ...
          if ($('.tt-ol-menu-anim').length) {
            tl_olMenuClick.to(
              '.tt-ol-menu-anim',
              { duration: 0.4, y: -60, autoAlpha: 0, stagger: 0.05, ease: Power2.easeIn },
              '-=0.4'
            );
          }
        });
      ...
      var $ttPortfolioSliderSwiper = new Swiper($ttPortfolioSlider.find('.swiper-container')[0], {
        ...
        on: {
          ...
          transitionStart: function () {
            ...
            gsap.fromTo(
              $ttPortfolioSlider.find('.land-up'),
              { autoAlpha: 0, y: 0 },
              { duration: 1.5, autoAlpha: 0, y: -30, stagger: 0.15, ease: Power2.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.boom-down'),
              { autoAlpha: 0, y: 0 },
              { duration: 1.5, autoAlpha: 0, y: 30, stagger: 0.15, ease: Power2.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.boom-down-fast'),
              { autoAlpha: 0, y: 0 },
              { duration: 0.25, autoAlpha: 0, y: 30, stagger: 0.15, ease: Power1.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.boom-down-slow'),
              { autoAlpha: 0, y: 0 },
              { duration: 2.5, autoAlpha: 0, y: 30, stagger: 0.75, ease: Power3.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.ani-witches'),
              { autoAlpha: 0, y: 0 },
              { duration: 2.5, autoAlpha: 0, y: -500, stagger: 0.75, ease: Power1.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.zoom-out'),
              { autoAlpha: 0 },
              { duration: 1.5, autoAlpha: 0, stagger: 0.15, ease: Power1.easeIn, scale: 0.95 }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.fade-left'),
              { autoAlpha: 0 },
              { duration: 0.4, autoAlpha: 0, stagger: 0.15, x: -50, skewX: 16, ease: Power3.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.fade-right'),
              { autoAlpha: 0 },
              {
                duration: 0.4,
                autoAlpha: 0,
            ...
            gsap.fromTo(
              $ttPortfolioSlider.find('.xtrum-right'),
              { autoAlpha: 0, x: 0 },
              { duration: 1.5, autoAlpha: 0, x: -50, stagger: 0.15, ease: Power3.easeIn }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.xtrum-left'),
              { autoAlpha: 0, x: 0 },
              { duration: 1.5, autoAlpha: 0, x: 50, stagger: 0.15, ease: Power3.easeIn }
            );
          },
          ...
          transitionEnd: function () {
            ...
            gsap.fromTo(
              $ttPortfolioSlider.find('.land-up'),
              { autoAlpha: 0, y: 30 },
              { duration: 1.5, autoAlpha: 1, y: 0, stagger: 0.15, ease: Power2.easeOut }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.boom-down'),
              { autoAlpha: 0, y: -30 },
            ...
            gsap.fromTo(
              $ttPortfolioSlider.find('.boom-down-slow'),
              { autoAlpha: 0, y: -30 },
              { duration: 2.5, autoAlpha: 1, y: 0, stagger: 0.75, ease: Power3.easeOut }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.ani-witches'),
              { autoAlpha: 0, y: 500 },
              { duration: 2.5, autoAlpha: 1, y: 0, stagger: 0.75, ease: Power1.easeOut }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.zoom-out'),
              { autoAlpha: 0 },
              { duration: 1.5, autoAlpha: 1, stagger: 0.15, ease: Power1.easeOut, scale: 1 }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.fade-left'),
              { autoAlpha: 0, x: -50, skewX: 16 },
              { duration: 0.4, autoAlpha: 0.9, stagger: 0.15, x: 0, skewX: 0, ease: Power3.easeOut }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.fade-right'),
              {
            ...
            gsap.fromTo(
              $ttPortfolioSlider.find('.xtrum-right'),
              { autoAlpha: 0, x: 50 },
              { duration: 1.5, autoAlpha: 1, x: 0, stagger: 0.15, ease: Power3.easeOut }
            );
            gsap.fromTo(
              $ttPortfolioSlider.find('.xtrum-left'),
              { autoAlpha: 0, x: -50 },
  ...
  if ($('.ph-share').length) {
    ...
    $('.ph-share').on('click', function () {
      ...
      tl_prshIn.from(
        '.ph-share-appear',
        { duration: 0.5, y: 80, autoAlpha: 0, stagger: 0.1, ease: Power2.easeOut },
        '+=0.1'
      );
    });
  ...
  if (!isMobile) {
    ...
    $('.portfolio-interactive-item').each(function () {
      var $piHoverSpeed = $(this).attr('scroll-speed');
      $(this)
  ...
  $('.anim-stretchinup').each(function () {
    ...
    tl_StretchInUp.from(
      this,
      { duration: 2, autoAlpha: 0, y: 100, scaleY: 1.4, transformOrigin: 'top', ease: Expo.easeOut, clearProps: 'all' },
      '+=0.2'
    );
  });
  ...
  $('.tt-ol-menu-toggle-btn-text, .tt-ol-menu-toggle-btn, .tt-m-menu-toggle-btn-text, .tt-m-menu-toggle-btn').on(
    'click',
    function () {
